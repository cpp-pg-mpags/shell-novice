...
indicating that the shell is waiting for input. This can take a number of forms, but
in the VSCode terminal it will be something similar to this:

~~~
root@ac6ffc13ebc3:/workspaces#
~~~
{: .language-bash}

Going forward, the material will use `$ ` as the prompt for clarity.
